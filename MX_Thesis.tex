...
\def\dedication{"Formal methods don't guarantee correctness, but they guarantee that we know what we're building."\\\\
— Tony Hoare\\\\[0.5cm]
To the clarity and confidence that formal verification brings to industrial automation.}
