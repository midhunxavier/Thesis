...
% Additional packages for Paper 13
\usepackage{soul}
\usepackage{rotating}
\usepackage{array}
...
\def\supervisorstring{Valeriy Vyatkin and Sandeep Patil} % Edit here if you have only one supervisor

\def\dedication{"To my family and friends who have supported me throughout this journey."}
...
% Create cover page with title, author name, and image
\makecoverpage
  {\thesistitle}
  {\theauthor}
  {\includegraphics[width=0.5\textwidth]{bg_wall.jpg}}

% Create title page with author information
\startpreamble
  {\thesistitle}
  {\theauthor}
  {\theaddress}
...
\makechapter{Model-Based Design Framework}{A Framework for Model-Based Design and Formal Verification of Component-Based Industrial Automation Systems}{A Framework for Model-Based Design and Formal Verification of Component-Based Industrial Automation Systems\label{ch2}}
\input{chapters/chapter2.tex}

\makechapter{Process Mining in Industrial Control Systems}{Process Mining in Industrial Control Systems}{Process Mining in Industrial Control Systems\label{ch3}}
\input{chapters/chapter3.tex}

\makechapter{Cross-Platform Testing and Portability Validation}{Cross-Platform Testing and Portability Validation for IEC 61499 Function Blocks}{Cross-Platform Testing and Portability Validation for IEC 61499 Function Blocks\label{ch4}}
\input{chapters/chapter4.tex}

\makechapter{Advanced Intelligent Systems for Industrial Automation}{Advanced Intelligent Systems for Industrial Automation: Blockchain, AI Agents, and Multi-Actor Frameworks}{Advanced Intelligent Systems for Industrial Automation: Blockchain, AI Agents, and Multi-Actor Frameworks\label{ch5}}
\input{chapters/chapter5.tex}

\makechapter{Conclusion and Future Research Directions}{Conclusion and Future Research Directions}{Conclusion and Future Research Directions\label{ch6}}
...
% Bibliography for Part I (Chapters)
