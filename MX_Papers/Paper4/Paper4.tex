...
\definecolor{backcolor2}{rgb}{0.941,0.941,0.941}
...
\author{GIORDANO LILLI\authorrefmark{1,2}, 
MIDHUN XAVIER\authorrefmark{3} \IEEEmembership{Student Member, IEEE}, 
ETIENNE LE PRIOL\authorrefmark{4}, \\
VINCENT PERRET\authorrefmark{4},
TATIANA LIAKH\authorrefmark{3} 
\IEEEmembership{Member, IEEE}, 
ROBERTO OBOE\authorrefmark{1} \IEEEmembership{Fellow, IEEE},
and VALERIY VYATKIN\authorrefmark{3,5} \IEEEmembership{Fellow, IEEE}}
...
\tfootnote{This work was supported, in part, by the HORIZON 2020 project 1-SWARM funded by the European Commission (grant agreement: 871743) and Horizon Europe project Zero-SWARM funded by the European Commission (grant agreement: 101057083).}

\corresp{CORRESPONDING AUTHOR: GIORDANO LILLI (e-mail: giordano.lilli@phd.unipd.it).}
...
\begin{figure}[t!]
    \centering
    \includegraphics[width=\columnwidth]{pictures/lilli13.eps}
